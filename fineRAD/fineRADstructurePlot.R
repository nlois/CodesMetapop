...
setwd("/Users/lc736/Desktop/LOIS/fineRADstructure/") ## The directory where the files are located
chunkfile<-"IDLE.haplotypes.tsv.fineRADpainter.lociFilt.samples50%missFilt_chunks.out" ## RADpainter output file
mcmcfile<-"IDLE.haplotypes.tsv.fineRADpainter.lociFilt.samples50%missFilt_chunks.mcmc.xml" ## finestructure mcmc file
treefile<-"IDLE.haplotypes.tsv.fineRADpainter.lociFilt.samples50%missFilt_chunks.mcmcTree.xml" ## finestructure tree file
### 2) EDIT THIS PATH TO WHERE YOU WANT THE PLOTS:
plotsFolder <- "/Users/lc736/Desktop/LOIS/fineRADstructure/"
### 3) SET VALUES FOR THESE VARIABLES: "analysisName" will be included in output plots
analysisName <- "IDLE";  maxIndv <- 10000; maxPop<-10000


### 4) EDIT THE PATH TO YOUR COPY of FinestructureLibrary.R
source("//Users/lc736/Desktop/LOIS/fineRADstructure/FinestructureLibrary.R", chdir = TRUE) # read in the R functions, which also calls the needed packages
